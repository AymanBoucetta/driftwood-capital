...
Revision ID: 732b71fe5b4a
Revises: 
Create Date: 2026-09-22 04:04:42.313953
"""
...
revision: str = '732b71fe5b4a'
down_revision: str | Sequence[str] | None = None
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

message_role_enum = postgresql.ENUM(
    'SYSTEM', 'USER', 'ASSISTANT', name='messagerole', create_type=False
)
...
def upgrade() -> None:
    ...
    sa.Column('chunk_metadata', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    op.create_index('ix_source_citations_chunk_id', 'source_citations', ['chunk_id'], unique=False)
    op.create_index('ix_source_citations_message_id', 'source_citations', ['message_id'], unique=False)
